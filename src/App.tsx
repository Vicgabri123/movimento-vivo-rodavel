...
function LogoMark() {
  return (
    <div className="flex items-center gap-3" data-testid="brand-movimento-vivo">
      ...
      <div className="leading-none">
        <div className="font-serif text-lg tracking-[-0.02em] text-[hsl(var(--sidebar-foreground))]">movimento</div>
        <div className="mt-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[hsl(var(--sidebar-primary))]">vivo</div>
      </div>
    </div>
  );
}
    ...
    <main className="mx-auto max-w-[1180px] px-5 py-8 md:px-10 md:py-12">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1.4fr_.75fr]">
        ...
        <aside className="space-y-5">
          ...
          <section className="rounded-2xl bg-[hsl(var(--sidebar))] p-5 text-[hsl(var(--sidebar-foreground))] shadow-sm"><div className="flex items-center gap-2 text-[hsl(var(--sidebar-primary))]"><Sparkles size={16} /><span className="text-xs font-bold uppercase tracking-[.12em]">Para levar hoje</span></div><p className="mt-4 font-serif text-xl leading-tight">“Movimento bom é o que cabe na sua vida.”</p><p className="mt-3 text-xs text-[hsl(var(--sidebar-foreground)/.6)]">— equipe Movimento Vivo</p></section>
        </aside>
      </div>
    </main>
  );
...
function SettingsPage({ preferences, setPreferences }: { preferences: Preferences; setPreferences: Dispatch<SetStateAction<Preferences>> }) {
  ...
  return (
    <main className="mx-auto max-w-[900px] px-5 py-8 md:px-10 md:py-12">
      <PageHeading eyebrow="Do seu jeito" title="Configurações" description="Ajuste o Movimento Vivo para que ele acompanhe você com mais conforto." />
